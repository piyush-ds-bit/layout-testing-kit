...
const ConnectPreview: React.FC = () => {
  return <section id="connect" className="portfolio-section">
      <div style={{
      boxShadow: '0 6px 32px 0 rgba(76,201,240,0.14), 0 2px 8px rgba(10,20,30,0.18), 0 1.5px 36px 0 rgba(0,0,0,0.13)'
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <Link to="/connect" className="flex items-center text-portfolio-accent hover:text-portfolio-accent-dark transition-colors">
        ...
        <div className="text-center">
          ...
          <div className="mt-8">
            <Link to="/connect" className="inline-block bg-portfolio-accent hover:bg-portfolio-accent-dark text-white font-medium px-8 py-3 rounded-lg transition-colors">
              Send Message
            </Link>
          </div>
        </div>

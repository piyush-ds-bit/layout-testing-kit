...
const PipelineControls: React.FC<PipelineControlsProps> = ({
  ...
  return <motion.div initial={{
    ...
    opacity: 1,
    y: 0
  }} className="p-3 rounded-lg bg-[#182437]/90 border border-portfolio-accent/30 backdrop-blur-sm max-w-fit px-0 py-[5px] flex-row flex items-center justify-center gap-[9px] mx-0">
      {/* Play/Pause Button */}

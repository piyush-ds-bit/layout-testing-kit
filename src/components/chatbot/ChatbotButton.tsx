...
const ChatbotButton: React.FC<ChatbotButtonProps> = ({
  ...
  return <motion.button initial={{
    ...
    scale: 0.9
  }} onClick={onClick} className="fixed bottom-32 md:bottom-6 lg:right-[316px] right-4 z-50 group" aria-label="Open chat">
      <div className="relative">
        ...
        {/* Unread badge */}
        {hasUnread && <div className="absolute -top-1 -right-1 w-3 h-3 bg-red-500 rounded-full border-2 border-portfolio-dark animate-pulse" />}
